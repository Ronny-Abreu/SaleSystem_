...
export default function EditarCliente() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Actualizar cliente (sin incluir el código ya que no se puede cambiar)
      const { codigo, ...datosActualizacion } = formData
      await clientesApi.update(clienteId, datosActualizacion)
    ...
    return (
      <div className="flex h-screen bg-slate-50">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <Header title="Editar Cliente" subtitle="Cargando información del cliente..." />
  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Header title="Editar Cliente" subtitle={`Modificar información de ${formData.nombre}`} />
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="card">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-slate-900">Editar Información del Cliente</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      title="El código del cliente no se puede modificar"
                    />
